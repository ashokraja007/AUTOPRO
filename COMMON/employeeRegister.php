...
<!-- Mirrored from htmldemo.net/carserv/carserv/register.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 06 Sep 2023 10:45:18 GMT -->
                    ...
                    <div class="header-main-wrapper">
                        ...
                        <div class="primary-menu d-none d-lg-block">
                            <ul class="nav-menu">
                                ...
                                <li><a href="supplierRegister.php">Supplier</a></li>
                                <li><a href="employeeRegister.php">Employee</a></li> -->
                                ...
                                <div class="form-wrapper">
                                    <form action="#" method="post">
                                        ...
                                        <div class="single-form">
                                            <input type="text" placeholder="Name" pattern="[a-z A-Z]+" required name="name">
                                        </div>
                                        <!-- Single Form End -->
                                        <!-- Single Form Start -->
                                        <div class="single-form">
                                        ...
                                        <div class="single-form">
                                            <input type="text" placeholder="Phone" pattern="[6789][0-9]{9}" required name="phone">
                                        </div>
                                        <div class="single-form">
                                            <input type="text" placeholder="Qualification" required name="quali">
                                        </div>
                                        <div class="single-form">
                                            <input type="text" placeholder="Experience (in Years)" required name="experience">
                                        </div>
                                        <div class="single-form">
                                            <textarea name="address" id="" cols="30" required rows="5" placeholder="Address"></textarea>
                                        </div>
                                        <!-- Single Form End -->
                                        <!-- Single Form Start -->
                                        <div class="single-form">
                                            <input type="password" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" title="Must contain at least one  number and one uppercase and lowercase letter, and at least 8 or more characters" placeholder="Password" name="password" required>
                                        </div>
                                        <!-- Single Form End -->
                                        <!-- Single Form Start -->
                                        <div class="single-form">
                                            <button type="submit" name="register" class="btn btn-custom-01 w-100">Create an account</button>
                                        </div>
                                        <!-- Single Form End -->
...
if (isset($_REQUEST['register'])) {
    ...
    if ($fetchData['cnt'] > 0) {
        echo "<script>alert('Already exists an Account with same Email/Phone');window.location='employeeRegister.php';</script>";
    } else {
        $qryReg = "INSERT INTO `employee`(`name`,`email`,`phone`,`address`,`qualification`,`experience`)VALUES('$Name','$Email','$Phone','$Address','$Quali','$Experience')";
        // echo $qryReg;
        $qryLog = "INSERT INTO `login` (`reg_id`,`email`,`password`,`usertype`,`status`) VALUES((SELECT MAX(`emp_id`) FROM `employee`),'$Email','$Password','Employee','Pending')";
        // echo $qryLog;
        if ($conn->query($qryReg) == TRUE && $conn->query($qryLog) == TRUE) {
            echo "<script>alert('Registration Success');window.location = 'login.php';</script>";
        } else {
            echo "<script>alert('Registration Failed');window.location = 'employeeRegister.php';</script>";
        }
    }
}
