...
<!-- Mirrored from htmldemo.net/carserv/carserv/login.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 06 Sep 2023 10:45:18 GMT -->
                        ...
                        <div class="primary-menu d-none d-lg-block">
                            <ul class="nav-menu">
                                ...
                                <li>
                                    <a href="#">Register</a>
                                    <ul class="sub-menu">
                                        <li><a href="../COMMON/customerRegister.php">Customer</a></li>
                                        <li><a href="../COMMON/supplierRegister.php">Supplier</a></li>
                                        <li><a href="../COMMON/employeeRegister.php">Employee</a></li>
                                    </ul>
                                </li>
                            </ul>
                            ...
                            <div class="register-login-form">
                                ...
                                <div class="form-wrapper">
                                    <form method="post">
                                        ...
                                        <!-- Single Form Start -->
                                        <div class="single-form">
                                            <button type="submit" name="login" class="btn btn-custom-01 w-100">Login</button>
                                        </div>
                                        <!-- Single Form End -->
    ...
    if ($result->num_rows > 0) {
        ...
        if ($status == 'Approved') {
            if ($type == 'Admin') {
                ...
                echo "<script>alert('Login Success');window.location='../SUPPLIER/supplierHome.php'</script>";
            } elseif ($type == 'Customer') {
                echo "<script>alert('Login Success');window.location='../CUSTOMER/customerHome.php'</script>";
            } elseif ($type == 'Employee') {
                echo "<script>alert('Login Success');window.location='../EMPLOYEE/employeeHome.php'</script>";
            }
        } else {
