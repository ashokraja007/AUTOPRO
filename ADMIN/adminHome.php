...
<!-- Mirrored from htmldemo.net/carserv/carserv/index.php by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 06 Sep 2023 10:44:53 GMT -->
                ...
                <div class="container">
                    ...
                    <div class="header-main-wrapper">
                        ...
                        <div class="header-logo">
                            <a href="adminHome.php"><img src="../assets/images/logo.png" alt="Logo"></a>
                        </div>
                        <!-- Header Logo End -->
                        ...
                        <div class="primary-menu d-none d-lg-block">
                            <ul class="nav-menu">
                                ...
                                <li>
                                    <a href="#">View</a>
                                    <ul class="sub-menu">
                                        <li><a href="adminViewSuppliers.php">Supplier</a></li>
                                        <li><a href="adminViewEmployee.php">Employees</a></li>
                                        <li><a href="adminViewCustomer.php">Customers</a></li>
                                        <li><a href="adminViewProducts.php">Products</a></li>
                                        <li><a href="adminViewRating.php">Feedbacks</a></li>
                                    </ul>
                                </li>
                                <li><a href="adminViewInventory.php">Inventory</a></li>
                                <li><a href="adminViewRequests.php">Requests</a></li>
                            </ul>
...
<!-- Mirrored from htmldemo.net/carserv/carserv/index.php by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 06 Sep 2023 10:45:15 GMT -->
