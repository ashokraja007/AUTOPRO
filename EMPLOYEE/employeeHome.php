        ...
        <div class="section header-section">
                ...
                <div class="container">
                    ...
                    <div class="header-top-wrapper">
                        ...
                        <div class="header-top-info">
                            <p>328D, Marine Drive, Kochi</p>
                            <p>Call us: <a>+12(025) 256 214</a></p>
                        </div>
                        ...
                        <!-- <div class="header-top-btn">
                            ...
                            <a href="./COMMON/register.php">Register</a>
                        </div> -->
                        <!-- Header top Wrapper End -->
            ...
            <div class="header-main">
                    ...
                    <div class="header-main-wrapper">
                        ...
                        <div class="primary-menu d-none d-lg-block">
                            <ul class="nav-menu">
                                ...
                                <li><a href="empRequestProducts.php">Request</a></li>
                                <li>
                                    <a href="#">Add</a>
                                    <ul class="sub-menu">
                                        <li><a href="addService.php">Service</a></li>
                                        <!-- <li><a href="adminViewEmployee.php">Employees</a></li>
                                        <li><a href="adminViewCustomer.php">Customers</a></li> -->
                                    </ul>
                                </li>
                                <li>
                                    <a href="#">View</a>
                                    <ul class="sub-menu">
                                        <li><a href="empViewService.php">Service</a></li>
                                        <li><a href="empViewBookings.php">Bookings</a></li>
                                        <li><a href="employeeViewProducts.php">Products</a></li>
                                    </ul>
                                </li>
                            </ul>
                ...
                <button><i class="icofont-search-2"></i></button>
                                ...
                                <a href="../COMMON/login.php" title="Logout"><img src="../assets/images/exit.svg" height="25px" width="25px" alt="Hello"></i></a>
                            </div>
            ...
            <div class="single-slider" style="background-image: url(../assets/images/slider/slider-bg.jpg);">
                <div class="container">
                    ...
                    <div class="slider-content">
                        ...
                        <h1 class="main-title" data-aos="fade-up" data-aos-delay="400">Need to Service or repair your
                            car?</h1>
                        <p data-aos="fade-up" data-aos-delay="600">Car servicing rationally encounter consequences that
                            extremely painful. Nor again is there anyone who loves or pursues </p>
                        <!-- <a href="contact.html" data-aos="fade-up" data-aos-delay="800" class="btn btn-custom-01">Contact
                            us</a> -->
                    </div>
                    <!-- Slider Section End -->
                </div>
                    ...
                    <div class="row align-items-end">
                        ...
                        <div class="col-lg-6">
                            ...
                            <div class="about-content" data-aos="fade-left" data-aos-delay="200">
                                ...
                                <!-- Section Title End -->
                                <p>Car servicing rationally encounter consequences extremely painful. Nor again is there
                                    anyone who loves or pursues take a trivial example, which of us undertakes chooses
                                </p>
                                <p>Car servicing rationally encounter consequences extremely painful. Nor again is there
                        ...
                        <div class="row gx-lg-5">
                            <div class="col-lg-4 col-sm-6">
                                ...
                                <div class="single-service" data-aos="fade-up" data-aos-delay="200">
                                    <h4 class="title"><a href="service-details.html">Anti Lock Brake <br> Servicing</a>
                                    </h4>
                            ...
                            <div class="col-lg-4 col-sm-6">
                                ...
                                <div class="single-service" data-aos="fade-up" data-aos-delay="400">
                                    <h4 class="title"><a href="service-details.html">Entire Engine <br> Servicing</a>
                                    </h4>
                                    <a href="service-details.html" class="more">Lean more</a>
                            ...
                            <div class="col-lg-4 col-sm-6">
                                <!-- Single Service Start -->
                                <div class="single-service" data-aos="fade-up" data-aos-delay="600">
                                    <h4 class="title"><a href="service-details.html">Tire Change <br> and Repair</a>
                                    </h4>
                                    <a href="service-details.html" class="more">Lean more</a>
                ...
                <div class="call-to-action-wrapper">
                    ...
                    <div class="call-to-action-content">
                        <div class="content-wrapper">
                            ...
                            <!-- Section Title End -->
                            <p>Car servicing rationally encounter consequences extremely painful. Nor again is there
                                anyone who loves or pursues of more than a quality servicing is very important </p>
                    ...
                    <div class="row align-items-center gx-xl-0">
                        <div class="col-lg-5">
                            ...
                            <div class="choose-content" data-aos="fade-right" data-aos-delay="300">
                                ...
                                <p>Trusted and reliable service is our main goal extremely painful. Nor again is there
                                    anyone who loves our to take a trivial example, which of us undertakes chooses</p>
        ...
        <div class="section section-padding-02">
            <div class="container">
                ...
                <div class="section-title text-center">
                    ...
                    <p>Trusted and reliable service is our main goal extremely <br> painful. Nor again is there anyone
                        who loves </p>
                </div>
                <!-- Section Title End -->
                            ...
                            <div class="swiper-wrapper">
                                <div class="swiper-slide">
                                    ...
                                    <div class="single-testimonials">
                                        ...
                                        <p>Great service makes me happy, my car is like the most the new one is our main
                                            goal extremely painful again is there anyone who loves our to take</p>
                                        <div class="rating">
            ...
            <div class="container">
                ...
                <div class="blog-wrapper">
                    ...
                    <div class="section-title">
                        ...
                        <p>Trusted and reliable service is our main goal extremely <br> painful. Nor again is there
                            anyone who loves </p>
                    </div>
                    <!-- Section Title End -->
                            ...
                            <div class="col-lg-4 col-md-6">
                                ...
                                <div class="single-blog" data-aos="fade-up" data-aos-delay="200">
                                    ...
                                    <div class="blog-content">
                                        ...
                                        <h3 class="title"><a href="blog-details-right-sidebar.html">Anti-lock Brake
                                                Servicing is very important for your vehical</a></h3>
                            ...
                            <div class="col-lg-4 col-md-6">
                                ...
                                <div class="single-blog" data-aos="fade-up" data-aos-delay="400">
                                    ...
                                    <div class="blog-content">
                                        ...
                                        <h3 class="title"><a href="blog-details-right-sidebar.html">Don’t do these 4
                                                things if you want your car to retain its value</a></h3>
                                        <a href="blog-details-right-sidebar.html" class="more">+ Read more</a>
                                    </div>
                                </div>
                                <!-- Single Blog End -->
                            ...
                            <div class="col-lg-4 col-md-6">
                                ...
                                <div class="single-blog" data-aos="fade-up" data-aos-delay="600">
                                    ...
                                    <div class="blog-content">
                                        ...
                                        <h3 class="title"><a href="blog-details-right-sidebar.html">Full car Diagnostic
                                                is important for every year maintainance</a></h3>
                                        <a href="blog-details-right-sidebar.html" class="more">+ Read more</a>
                                    </div>
                                </div>
                                <!-- Single Blog End -->
                        ...
                        <div class="row">
                            <div class="col-lg-3 col-md-6 order-md-1 order-lg-1">
                                ...
                                <div class="footer-widget" data-aos="fade-up" data-aos-delay="100">
                                    ...
                                    <p>Trusted and reliable service is our to main goal extremely painful. again a there
                                        anyone loves our chooses</p>
                            ...
                            <div class="col-lg-3 col-md-6 order-md-2 order-lg-3">
                                ...
                                <div class="footer-widget" data-aos="fade-up" data-aos-delay="400">
                                    ...
                                    <div class="widget-opening">
                                        ...
                                        <p>Monday to Friday <i class="fa fa-long-arrow-right"></i> 9.30 am to 11.30 pm
                                        </p>
                                        <p>Saturday to Sunday <i class="fa fa-long-arrow-right"></i> 10.30 am to 8 pm
                                        </p>
                                    </div>
                                </div>
                                <!-- Footer Widget End -->
...
<!-- Mirrored from htmldemo.net/carserv/carserv/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 06 Sep 2023 10:45:15 GMT -->
