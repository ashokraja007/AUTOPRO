...
<!-- Mirrored from htmldemo.net/carserv/carserv/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 06 Sep 2023 10:44:53 GMT -->
                        ...
                        <div class="primary-menu d-none d-lg-block">
                            <ul class="nav-menu">
                                ...
                                <li>
                                    <a href="#">View</a>
                                    <ul class="sub-menu">
                                        <li><a href="customerViewServices.php">Services</a></li>
                                        <li><a href="customerViewBookings.php">Bookings</a></li>
                                    </ul>
                                </li>
                            </ul>
                        </div>
